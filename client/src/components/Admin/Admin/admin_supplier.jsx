...
export default function Admin_Supplier(){
     ...
     useEffect(() => {
    axios.get('https://af-global-2021.herokuapp.com/admin_supplier/view')
    .then(res => setSupplier(res.data))
    .catch(error => console.log(error));
  });

  function updatePersonStatus(id){
        axios.put("https://af-global-2021.herokuapp.com/admin_keynote/deleteEmail/"+id).then(() =>{
                         ...
                         <div class="card" >
                            ...
                            <div class="card-body">
                              ...
                              <div class="bg-white  d-grid gap-2">
                                <button type="button"  class="btn btn-success btn-sm rounded-0">View</button>
                              </div>
