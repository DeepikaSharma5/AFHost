...
export default function AddKeyNoteSpeaker() {
    ...
    const onSubmit = () => {
        ...
        axios.post("https://api.cloudinary.com/v1_1/applicationframework2021/image/upload", formData).then((response) => {
            ...
            axios.post("https://af-global-2021.herokuapp.com/keynoteSpeaker/add", AddKeyNoteSpeaker)
                .then(() => {
                    Swal.fire({
                        title: "Success!",
                        text: "Keynote Speaker Saved",
                        icon: 'success',
                    ...
                    Swal.fire({
                        title: "Error!",
                        text: "Unable to save Keynote Speker",
                        icon: 'error',
                        confirmButtonText: "OK",
                        type: "success"
                    })
    ...
    return (
        <div>
            <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
                <h1 tag='div' className='display-1 pb-3 mb-3 border-bottom'>Add KeyNote Speakers</h1>
            </div>
            <div className="col-md-14 col-sm-12" style={{ maxWidth: '70rem', margin: 'auto', padding: '10px' }}>
                <div className="row g-0">
                    ...
                    <div className="form-outline mb-4">
                        ...
                        <input type="file" onChange={(e) => { setimageSelected(e.target.files[0]) }} className="form-control" id="customFile" />
                    </div>
                    <div className="form-outline mb-4">
