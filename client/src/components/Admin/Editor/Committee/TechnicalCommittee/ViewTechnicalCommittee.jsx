...
export default function ViewTechnicalCommittee() {
    ...
    useEffect(() => {
        axios.get('https://af-global-2021.herokuapp.com/techCommittee/viewTechnicalCommittee/')
            .then(res => setTechnicalCommittee(res.data))
            .catch(error => console.log(error));
    })

    function deleteTechnicalCommitteeMember(id) {
        axios.delete('https://af-global-2021.herokuapp.com/techCommittee/deleteTechnicalCommittee/' + id)
            .then(() => {
                Swal.fire({
                    title: "Success!",
