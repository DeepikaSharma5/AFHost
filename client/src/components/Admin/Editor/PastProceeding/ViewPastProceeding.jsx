...
export default function ViewPastProceeding() {
    ...
    function deletePastProceeding(id) {
        axios.delete('https://af-global-2021.herokuapp.com/pastProceeding/delete/' + id)
            .then(() => {
                Swal.fire({
                    title: "Success!",
                    text: "Past Proceeding Deleting Successed!",
                    icon: 'success',
                ...
                Swal.fire({
                    title: "error!",
                    text: "Past Proceeding Deleting Not Success",
                    icon: 'error',
                    position: 'center',
