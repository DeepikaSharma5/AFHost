...
export default function Login() {
    ...
    async function sendDate(e){
        ...
        let result = await fetch("https://af-global-2021.herokuapp.com/updatePassword/:email", {
        method: 'POST',
        headers:{
  ...
  return (
      <div>
          ...
          <div class="row mt-5 mb-5">
              ...
              <img src="https://i.imgur.com/hU7mgwt.jpeg" style={{width:'70%'}} class="img-fluid pt-5" alt=".."/>
              </div>
