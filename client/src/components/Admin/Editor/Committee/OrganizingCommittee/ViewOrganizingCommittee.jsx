...
export default function ViewOrganizingCommittee() {
    ...
    useEffect(() => {
        axios.get('https://af-global-2021.herokuapp.com/orgCommittee/viewOrganizingCommittee/')
            .then(res => setOrganizingCommittee(res.data))
            .catch(error => console.log(error));
    })

    function deleteOrganizingCommitteeMember(id) {
        axios.delete('https://af-global-2021.herokuapp.com/orgCommittee/deleteOrganizingCommittee/' + id)
            .then(() => {
                Swal.fire({
                    title: "Success!",
