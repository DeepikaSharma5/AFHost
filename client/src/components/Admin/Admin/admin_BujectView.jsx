...
export default function Admin_BujectView(){
    ...
    axios.post("https://af-global-2021.herokuapp.com/admin_accept_budject/add",newBudject).then(() =>{
     e.preventDefault();
     Swal.fire({  
       title: "Success!",
       text: "Budject Saved",
    ...
    useEffect(() => {
       axios.get('https://af-global-2021.herokuapp.com/admin_accept_budject/retriveBudject')
   ...
   function saveIncome(e){
     ...
     axios.post("https://af-global-2021.herokuapp.com/admin_accept_budject/addMoney",newIncome).then(() =>{
     e.preventDefault();
     Swal.fire({  
       title: "Success!",
       text: "Income Added",
   ...
   const [TotalIncome,setTotalIcome] = useState([]);
     useEffect(() => {
    axios.get('https://af-global-2021.herokuapp.com/admin_accept_budject/searchIncome')
   ...
   useEffect(() => {
    axios.get('https://af-global-2021.herokuapp.com/admin_accept_budject/searchExpences')
