...
export default function AddTechnicalCommittee() {
    ...
    const onSubmit = () => {
        ...
        axios.post("https://api.cloudinary.com/v1_1/applicationframework2021/image/upload", formData).then((response) => {
            ...
            axios.post("https://af-global-2021.herokuapp.com/techCommittee/addTecCommittee", AddTechnicalCommittee)
                .then(() => {
                    Swal.fire({
                        title: "Success!",
                        text: "Technical Committee Member Saved",
                        icon: 'success',
                    ...
                    Swal.fire({
                        title: "Error!",
                        text: "Unable to save Technical Committee Member",
                        icon: 'error',
                        confirmButtonText: "OK",
                        type: "success"
                    })
